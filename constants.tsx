...
const RESIDENTS_DATA_BASE = [
  { id: '1', name: 'Cyrus C.', clubId: 'math-garden', garmentImage: "server/public/images/Cyrus.jpg" }, 
  { id: '2', name: 'Sam D.', clubId: 'flight-sim', garmentImage: "server/public/images/Sam.jpg" }, 
  { id: '3', name: 'James Z.', clubId: 'flight-sim', garmentImage: "server/public/images/James.jpg" },
  { id: '4', name: 'Simon H.', clubId: 'mc-econ', garmentImage: "server/public/images/Simon.jpg" },
  { id: '5', name: 'Apple Z.', clubId: 'racing-sim', garmentImage: "server/public/images/Apple.jpg" }, 
  { id: '6', name: 'Michael W.', clubId: '3d-print', garmentImage: "server/public/images/Michael.jpg" },
  { id: '7', name: 'Watson W.', clubId: 'flight-sim', garmentImage: "server/public/images/Watson.jpg" }, 
  { id: '8', name: 'Edgar Z.', clubId: 'racing-sim', garmentImage: "server/public/images/Edgar.jpg" }, 
  { id: '9', name: 'Andy W.', clubId: 'racing-sim', garmentImage: "server/public/images/Andy.jpg" }, 
  { id: '10', name: 'Javier S.', clubId: 'ecoharbor', garmentImage: "server/public/images/Javier.jpg" }, 
  { id: '11', name: 'Rey Q.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Rey.jpg" }, 
  { id: '12', name: 'Albert G.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Albert.jpg" }, 
  { id: '13', name: 'Steve H.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Steve.jpg" }, 
  { id: '14', name: 'Ethan W.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Ethan.jpg" }, 
  { id: '15', name: 'Luke L.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Undefined.jpg" }, 
  { id: '16', name: 'Will Z.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Undefined.jpg" },
  { id: '17', name: 'Charlie F.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Undefined.jpg" },
  { id: '18', name: 'Stone W.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Undefined.jpg" },
  { id: '19', name: 'Ruian W.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Undefined.jpg" },
  { id: '20', name: 'Justin H.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Undefined.jpg" },
  { id: '21', name: 'Zee L.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Undefined.jpg" },
  { id: '22', name: 'Steve H.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Undefined.jpg" },
  { id: '23', name: 'Steve H.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Undefined.jpg" },
  { id: '24', name: 'Steve H.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Undefined.jpg" },
  { id: '25', name: 'Steve H.', clubId: 'societal-hotspot', garmentImage: "server/public/images/Undefined.jpg" },
